...
int n_props, iv, iw, ip, igofr, F, E;
double vtail,ptail,bin_size,nbins,sd;
double walker[m_props];
bool Realsimulation,restart;


// averages
double blk_av[m_props],blk_norm,accepted,attempted,d;
double glob_av[m_props],glob_av2[m_props];
double stima_pot,stima_pres,err_pot,err_press,err_gdir;
double stimais_pot,stimais_pres;
...
void isto(double *,int ,double ,double, double, double);
double Acceptance();
